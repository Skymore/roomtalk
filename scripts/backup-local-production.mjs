...
try {
  run(['stop', 'cloudflared', 'cloudflared-wenlin', 'app', 'ai-worker', 'object-storage'])
  run([
    '--profile',
    'ops',
    'run',
  ...
  run(['--profile', 'edge', 'start', 'object-storage', 'app', 'ai-worker', 'cloudflared', 'cloudflared-wenlin'], true)
}
