...
const options = {
  contextDir: process.env.CODE_AGENT_E2B_BUILD_CONTEXT || '/tmp/roomtalk-code-agent-e2b-template-context',
...
Options:
  ...
  --context <dir>      Build context directory. Defaults to /tmp/roomtalk-code-agent-e2b-template-context.
