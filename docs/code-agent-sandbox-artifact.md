...
```text
artifactVersion: roomtalk-code-agent-2026-07-31-multi-harness-v3
...
```bash
docker build -t roomtalk-code-agent:roomtalk-code-agent-2026-07-31-multi-harness-v3 /tmp/roomtalk-code-agent-sandbox-context
```
...
node scripts/code-agent/build-e2b-template.mjs \
  --clean \
  --template roomtalk-code-agent-2026-07-31-multi-harness-v3 \
  --publish
```
