  ...
  return (
    ...
    >
      <div className="flex justify-center">
        <div className="flex h-10 w-full max-w-md items-center justify-around px-4">
          <Button
            isIconOnly
            variant={view === "rooms" ? "solid" : "light"}
            color="default"
            onPress={() => setView("rooms")}
            className={`h-8 w-11 min-w-11 rounded-xl ${view === "rooms" ? activeClass : inactiveClass}`}
            aria-label={t("home")}
          ...
          <Button
            ...
            className={`h-8 w-11 min-w-11 rounded-xl ${view === "saved" ? activeClass : inactiveClass}`}
          ...
          <Button
            ...
            className={`h-8 w-11 min-w-11 rounded-xl ${view === "chat" ? "bg-secondary text-secondary-foreground shadow-[0_0_0_1px_hsl(var(--heroui-secondary))]" : inactiveClass}`}
            aria-label={currentRoom ? `${t("chatRooms")}: ${currentRoom.name}` : t("chatRooms")}
          ...
          <Button
            ...
            className={`h-8 w-11 min-w-11 rounded-xl ${view === "settings" ? activeClass : inactiveClass}`}
