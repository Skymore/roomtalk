...
export const CodeAgentToolMessage: React.FC<CodeAgentToolMessageProps> = ({ message, pairedResult }) => {
  ...
  return (
    <div className="my-0.5 max-w-full">
      <button
        type="button"
        data-testid={isToolCall ? 'code-agent-tool-call' : 'code-agent-tool-result'}
        className={`
