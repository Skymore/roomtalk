...
Use `CLIENT_URL` for the primary public client URL. Set `CLIENT_URLS` to a comma-separated origin allowlist when multiple production domains should work, for example `https://room.ruit.me,https://room.ruit.me`.
